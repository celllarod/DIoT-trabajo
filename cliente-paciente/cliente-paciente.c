...
#define ALERTA_TEMPERATURA "1"
#define ALERTA_TEMPERATURA_FIN "2"
...
PROCESS_THREAD(temperature_sensor_process, ev, data)
{
  ...
  while (1)
  {
    ...
    /* Imprimimos la temperatura con 2 decimales teniendo en cuenta que es un entero y 
     * que la resolucion es de 0.25 haciendo cast a float.
...
/*---------------------------------------------------------------------------
 * Proceso que lee el boton y envia evento al servidor si se pulsa durante 3s.
 *---------------------------------------------------------------------------*/
